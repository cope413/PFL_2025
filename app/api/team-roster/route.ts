...
export async function GET(request: NextRequest) {
  try {
    ...
    const transformedPlayers = players.map((player: any) => {
      ...
      const weekPoints = [
        player.week_1, player.week_2, player.week_3, player.week_4,
        player.week_5, player.week_6, player.week_7, player.week_8,
        player.week_9, player.week_10, player.week_11, player.week_12,
        player.week_13, player.week_14
      ];
